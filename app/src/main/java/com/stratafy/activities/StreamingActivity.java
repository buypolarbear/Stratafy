...
public class StreamingActivity extends AppCompatActivity implements RtmpHandler.RtmpListener,
    ...
    private String rtmpUrl = "rtmp://ec2-35-166-240-31.us-west-2.compute.amazonaws.com/live/"+ MainActivity.property_id;
    ...
    private boolean checkandRequestPermission() {
        ...
        if (!listpermissionNeeded.isEmpty()) {
            ActivityCompat.requestPermissions(StreamingActivity.this, listpermissionNeeded.toArray(new String[listpermissionNeeded.size()]), REQUEST_ID_MULTIPLE_PERMISSIONS);
            return false;
        }
        return true;
    }
