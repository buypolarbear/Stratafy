...
import com.pixeldart.fragment.FragmentApprove;
...
public class AdapterArchived extends RecyclerView.Adapter<AdapterArchived.MyViewHolder> {
    private Context context;
    private List<Archived> myLogsList;
    private final LayoutInflater inflater;

    public AdapterArchived(Context context, List<Archived> mLogList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final Archived logs = myLogsList.get(position);
