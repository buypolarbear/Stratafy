...
public class PublicLogs implements Parcelable {
    ...
    protected PublicLogs(Parcel in) {
        id = in.readString();
    ...
    public static final Creator<PublicLogs> CREATOR = new Creator<PublicLogs>() {
        @Override
        public PublicLogs createFromParcel(Parcel in) {
            return new PublicLogs(in);
        }

        @Override
        public PublicLogs[] newArray(int size) {
            return new PublicLogs[size];
        }
    };
