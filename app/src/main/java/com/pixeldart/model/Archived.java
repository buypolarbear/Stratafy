...
public class Archived implements Parcelable {
    ...
    public static final Creator<Archived> CREATOR = new Creator<Archived>() {
        @Override
        public Archived createFromParcel(Parcel in) {
            return new Archived(in);
        }

        @Override
        public Archived[] newArray(int size) {
            return new Archived[size];
        }
    };
